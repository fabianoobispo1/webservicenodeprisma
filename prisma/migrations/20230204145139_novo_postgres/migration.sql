...
CREATE TABLE "exercise_week_days" (
    ...
    CONSTRAINT "exercise_week_days_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "exercise_week_days" ADD CONSTRAINT "exercise_week_days_exercise_id_fkey" FOREIGN KEY ("exercise_id") REFERENCES "exercises"("id") ON DELETE CASCADE ON UPDATE CASCADE;
